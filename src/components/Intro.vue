<template>
  <section>
    <div>
      <h2>
        This modpack transforms Minecraft into an immersive world full of exploration and realism.
      </h2>
      <p>
        Step into a world where survival meets subtle beauty.
        <br />
        In WildLight, every sound, texture, and detail is crafted to pull you deeper into a refined
